...
void left_side() {
  ...
  FW.move(0.97 * 127 * reverseFW); // start flywheel
...
void programmingSkills() {
  ...
  FW.move(0.845 * 127 * reverseFW); // start flywheel
  ...
  FW.move(0.815 * 127 * reverseFW); // start flywheel
  ...
  FW.move(0.854 * 127 * reverseFW); // start flywheel
  ...
  FW.move(0.791 * 127 * reverseFW); // start flywheel
  ...
  FW.move(0.83 * 127 * reverseFW); // start flywheel
  ...
  FW.move(0.82 * 127 * reverseFW); // start flywheel
